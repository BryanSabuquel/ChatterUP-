...
<head>
    ...
    <title>Realtime Chatter App</title>
...
<script>
  ...
  incoming_id = chatFooter.querySelector(".incoming_id").value,
  inputField = chatFooter.querySelector(".input-field"),
  sendBtn = chatFooter.querySelector("button"),
  chatBox = document.querySelector(".chat-box");
// Prevent form submission logic is no longer needed, as there's no form
  inputField.focus();
